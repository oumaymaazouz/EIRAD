...
let menu_about_item_mobile = document.getElementById(
  "menu-item-about-for-mobile"
);
let sub_menu_about_mobile = document.getElementById(
  "sub-menu-list-about-for-mobile"
);
...
function handleShareLocationModalVisibility() {
  ...
  document
    .querySelector(".share-location-modal-overlay")
    .classList.toggle("share-location-modal-overlay-visible");
}
